...
print('Args')
print('    {}'.format(args))
lr, momentum, weight_decay = args.pop('lr'), args.pop('momentum'), args.pop('weight_decay')
...
# deine optimizer
optimizer = MomentumSGD(model, lr=lr, momentum=momentum, schedule=[100, 150], lr_decay=0.1, weight_decay=weight_decay)
optimizer.info()
